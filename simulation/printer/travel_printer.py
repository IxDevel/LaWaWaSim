...
titulador = 'UnitId,Lat,Lon,DistR,OPedId,TPedId,Dis,ETA,RouteOwner,RouteId\n'
...
class TravelPrinter:
    ...
    def log(self):
        ...
        for travel in self.__travels:
            ...
            lista = str('{:3d}'.format(travel.unit.uid)) + ',' + str('{:10.8f}'.format(travel.unit.current_position.latitude)) + ',' + str('{:10.8f}'.format(travel.unit.current_position.longitude)) + ',' + str('{:12.8f}'.format(travel.unit.mileage)) + ',' + str('{:3d}'.format(travel.origin_ped.uid)) + ',' + str('{:3d}'.format(travel.target_ped.uid)) + ',' + str('{:10.8f}'.format(travel.distance)) + ',' + str('{:10.8f}'.format(travel.time_to_arrival * 60)) + ',' + str('{:3d}'.format(travel.route.owner_id)) + ',' + str('{:3d}'.format(travel.route.uid))+'\n'
            prueba.write(lista)